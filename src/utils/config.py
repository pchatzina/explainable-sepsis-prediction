...
class Config:
    ...
    RESULTS_UNIMODAL_DIR = RESULTS_DIR / "unimodal"
    RESULTS_FUSION_DIR = RESULTS_DIR / "fusion"
    RESULTS_UNIMODAL_METRICS_DIR = RESULTS_UNIMODAL_DIR / "metrics"
    RESULTS_UNIMODAL_PREDICTIONS_DIR = RESULTS_UNIMODAL_DIR / "predictions"
    RESULTS_UNIMODAL_REPORTS_DIR = RESULTS_UNIMODAL_DIR / "reports"
    RESULTS_FUSION_METRICS_DIR = RESULTS_FUSION_DIR / "metrics"
    RESULTS_FUSION_PREDICTIONS_DIR = RESULTS_FUSION_DIR / "predictions"
    RESULTS_FUSION_REPORTS_DIR = RESULTS_FUSION_DIR / "reports"
    RESULTS_INCREMENTAL_VALUE_METRICS_DIR = (
        RESULTS_DIR / "incremental_value_analysis" / "metrics"
    )
    RESULTS_INCREMENTAL_VALUE_PREDICTIONS_DIR = (
        RESULTS_DIR / "incremental_value_analysis" / "predictions"
    )
    ...
    # =========================================================================
    EMBEDDING_DIMS = {
        "ehr": 768,  # StanfordShahLab/motor-t-base
        "ecg": 768,  # wanglab/ecg-fm
        "cxr_img": 1024,  # torchxrayvision/densenet121-res224-all
        "cxr_txt": 768,  # emilyalsentzer/Bio_ClinicalBERT
    }

    # Fusion run names (used by figure_generator, report_generator, and calibration recovery).
    FUSION_RUN_PRETRAINED = "4mod_pretrained_final"
    FUSION_RUN_SCRATCH = "4mod_scratch_final"
