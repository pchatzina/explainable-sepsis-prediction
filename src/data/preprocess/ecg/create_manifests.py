...
MAT_DIR = Config.PROCESSED_ECG_ROOT_DIR / "preprocessed"
OUTPUT_DIR = Config.PROCESSED_ECG_MANIFEST_DIR
SQL_CSV = Config.PROCESSED_ECG_LABELS_DIR / "labels.csv"
    ...
    for sql_split, fairseq_split in split_map.items():
        ...
        with open(tsv_path, "w") as f_tsv, open(lbl_path, "w") as f_lbl:
            ...
            for _, row in subset.iterrows():
                # Cast to int to prevent Pandas from formatting it as a float
