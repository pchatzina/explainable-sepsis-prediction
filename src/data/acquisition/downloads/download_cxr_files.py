...
This module has two responsibilities:
  ...
  1. download_reports(): Downloads CXR_REPORTS_FILE (ZIP archive with all radiology reports)
  2. download_images(): Downloads individual CXR JPG images for cohort patients
"""
...
def download_reports():
    """Download CXR reports ZIP archive from PhysioNet."""
...
def download_images():
    """Download individual CXR JPG images for all cohort patients."""
    logger.info("Starting CXR Image Download for Cohort...")
    engine = get_engine()

    query = text("SELECT subject_id, study_path FROM mimiciv_ext.cohort_cxr")
