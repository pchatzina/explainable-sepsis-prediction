-- ===================================================================
-- Script: create_training_split.sql
-- ===================================================================
-- Purpose: Stratified splitting of cohort into train/validate/test sets
--          ensuring balanced distribution across modalities and temporal factors.
--
-- Stratification Strategy:
--   Train : Validate : Test = 70% : 15% : 15%
--   Stratified by FOUR independent factors to preserve distribution:
--   1. Sepsis Label (positive vs. negative)
--   2. Modality Signature (EHR | EHR_CXR | EHR_ECG | EHR_CXR_ECG)
--   3. CXR Freshness Tier (Fresh:0-12h | Recent:12-24h | Older:>24h | N/A)
--   4. ECG Freshness Tier (Fresh:0-12h | Recent:12-24h | Older:>24h | N/A)
--
-- Rationale for Stratification:
--   - Sepsis Label: Ensures all splits have same positive/negative ratio
--     (prevents overrepresentation of negatives in training)
--   - Modality Signature: Ensures each split has same distribution of auxiliary modalities
--     (prevents train from getting all EHR_CXR_ECG while test gets EHR-only)
--   - Freshness Tiers: Ensures temporal recency is preserved across splits
--     (prevents temporal bias from "older" studies concentrated in test set)
--
-- Output Distribution (expected):
--   Train (70%):   10,845 patients
--   Validate (15%): 2,326 patients
--   Test (15%):    2,342 patients
-- ===================================================================
